...
namespace TwitchLib.Client.Models
{
    public class Subscriber : SubscriberBase
    {
        ...
        public Subscriber(List<KeyValuePair<string, string>> badges, List<KeyValuePair<string, string>> badgeInfo, string colorHex, Color color, string displayName, string emoteSet, string id, string login, string systemMessage,
