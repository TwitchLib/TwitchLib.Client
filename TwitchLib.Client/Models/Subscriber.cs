...
namespace TwitchLib.Client.Models
{
    public class Subscriber : SubscriberBase
    {
        ...
        internal Subscriber(List<KeyValuePair<string, string>> badges, string colorHex, Color color, string displayName, string emoteSet, string id, string login, string systemMessage,
