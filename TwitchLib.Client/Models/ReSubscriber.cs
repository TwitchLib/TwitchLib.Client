...
namespace TwitchLib.Client.Models
{
    public class ReSubscriber : SubscriberBase
    {
        ...
        internal ReSubscriber(List<KeyValuePair<string, string>> badges, string colorHex, Color color, string displayName, string emoteSet, string id, string login, string systemMessage,
